  ...
  function form($instance) {
    ?>
      ...
      <p>
          ...
          <input type="text" name="<?php echo $this->get_field_name('ShowTags'); ?>" id="<?php echo $this->get_field_id('ShowTags'); ?>" value="<?php if (empty($instance['ShowTags'])) {
            echo esc_attr(NUMBERTAGS);
          } else {
            echo esc_attr($instance['ShowTags']);
          } ?>" size="3" />
      </p>
    <?php
  }
